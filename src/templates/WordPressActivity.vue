...
<template>
  <Layout>
        ...
        <nav class="activity-nav">
          <ul class="activity-nav__ul">
            ...
            <li class="activity-nav__li"
              ...
              <button type="button" @click="scrollTo('sponsors')" class="activity-nav__link">Спонсоры и партнеры
              </button>
            </li>
            <li class="activity-nav__li"
          ...
          <div class="timings">
            <div class="timings__item"
              ...
              <div class="timings__item-bot">
                ...
                <div class="timings__item-date">{{ timing.date | formatDateWithTime }}</div>
              </div>
            </div>
          </div>
        </section>
    ...
    <section class="container sponsors-section"
             id="sponsors"
             v-if="$page.wordPressActivity.acf.sponsors && $page.wordPressActivity.acf.sponsors.length">
      <h2 class="sponsors-section__title">Спонсоры и партнеры</h2>
      <div class="sponsors">
